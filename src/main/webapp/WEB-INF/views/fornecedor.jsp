    ...
    <form:form class="form-cadastro my-2" id="form-cadastro" modelAttribute="dtoUsuario" action="${pageContext.request.contextPath}/fornecedor/salvar" method="POST">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                <form:label path="nome" for="inputNome">Razão Social:</form:label>
                <form:input path="nome" type="text" class="form-control" id="inputNome" maxlength="100" />
            </div>
            <div class="form-group col-md-3">
                <form:label path="sobrenome" for="inputSobrenome">Nome Fantasia:</form:label>
                <form:input path="sobrenome" type="text" class="form-control" id="inputSobrenome" maxlength="100" />
            </div>
            <div class="form-group col-md-3">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                <form:label path="observacao" for="inputObservacao">Site Comercial:</form:label>
